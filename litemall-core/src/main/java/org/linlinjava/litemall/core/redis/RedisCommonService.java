...
public class RedisCommonService implements IRedisCommonService {
    ...
    public Boolean getBit(String key, long value) {
        return instance.execute(new RedisCallback<Boolean>() {
            @Override
            public Boolean doInRedis(RedisConnection redisConnection) throws DataAccessException {
                return redisConnection.getBit(getBytes(key), value);
            }
        });
    }
    ...
    public Boolean setBit(String key, long value, boolean flag) {
        return instance.execute(new RedisCallback<Boolean>() {
            @Override
            public Boolean doInRedis(RedisConnection redisConnection) throws DataAccessException {
                return redisConnection.setBit(getBytes(key), value, flag);
            }
        });
    }
    ...
    public Long bitCount(String key) {
        return instance.execute(new RedisCallback<Long>() {
            @Override
            public Long doInRedis(RedisConnection redisConnection) throws DataAccessException {
                return redisConnection.bitCount(getBytes(key));
            }
        });
    }
    ...
    public Long bitCount(String key, long value1, long value2) {
        return instance.execute(new RedisCallback<Long>() {
            @Override
            public Long doInRedis(RedisConnection redisConnection) throws DataAccessException {
                return redisConnection.bitCount(getBytes(key), value1, value2);
            }
        });
    }
}
