...
public class LitemallCategoryService {
    ...
    private LitemallCategory.Column[] CHANNEL = {LitemallCategory.Column.id, LitemallCategory.Column.name, LitemallCategory.Column.iconUrl, LitemallCategory.Column.link};
