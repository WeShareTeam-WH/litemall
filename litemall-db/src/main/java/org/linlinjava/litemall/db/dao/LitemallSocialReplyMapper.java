...
public interface LitemallSocialReplyMapper {
     ...
     * @mbg.generated
     */
    LitemallSocialReply selectOneByExampleWithBLOBs(LitemallSocialReplyExample example);
     ...
     * @mbg.generated
     */
    List<LitemallSocialReply> selectByExampleWithBLOBs(LitemallSocialReplyExample example);
     ...
     * @mbg.generated
     */
    int updateByExampleWithBLOBs(@Param("record") LitemallSocialReply record, @Param("example") LitemallSocialReplyExample example);
     ...
     * @mbg.generated
     */
    int updateByPrimaryKeyWithBLOBs(LitemallSocialReply record);
